...
var controller = {
    ...
    var audio1 = new Audio('ss1.mp3');
    reader.readAsText(file, "UTF-8");
     reader.onload = function (evt)
     {
       var so = new Audio('flight.mp3');
       so.play();
 ...
 //      delay = v[1];
        ...
        canvasView.setWall(v[3]);
       var delay = Delay(v[1]);
       for(var i=4;i<v.length-1;i++)
       {   
         if(v[i]=="move")
         {
            setTimeout(function(){
             controller.move(v[3],list1);
           audio.play();
           },delay*i);     
        }
         else if(v[i]=="right")
        ...
        else if(v[i].charAt(0)=='i')
         { 
           setTimeout(function(){
             controller.movel(v[3],list1);
           audio1.play();
            },delay*i);
          }
        else 
